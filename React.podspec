#
#  Be sure to run `pod spec lint YYImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = { :type => "Copyright", :text => "React" }
  ...
  s.author             = { "facebook" => "facebook@github.com" }
  s.source             = { :git => "https://github.com/delonchen2011/ReactNative.git", :tag => s.version.to_s }
